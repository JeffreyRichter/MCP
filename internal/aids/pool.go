...
// Similarly, a call to New returning x “synchronizes before” a call to Get returning that same value x.
//
// [the Go memory model]: https://go.dev/ref/mem
type Pool[T any] sync.Pool

// New creates a new generic Pool with the provided function to create new items if the pool is empty.
func NewPool[T any](newFunc func() T) *Pool[T] {
	return (*Pool[T])(&sync.Pool{New: func() any { return newFunc() }})
}

...
type ToolCallStore interface {
	Get(ctx context.Context, tenant string, toolCall *toolcalls.ToolCall, accessConditions *toolcalls.AccessConditions) (*toolcalls.ToolCall, error)
	Put(ctx context.Context, tenant string, toolCall *toolcalls.ToolCall, accessConditions *toolcalls.AccessConditions) (*toolcalls.ToolCall, error)
	Delete(ctx context.Context, tenant string, toolCall *toolcalls.ToolCall, accessConditions *toolcalls.AccessConditions) error
}
